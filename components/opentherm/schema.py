...
SENSORS: Schema[SensorSchema] = Schema({
    ...
    "oem_diagnostic_code_ventilation_heat_recovery": SensorSchema({
        "description": "An OEM-specific diagnostic/service code for ventilation / heat-recovery system",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0, 
        "state_class": STATE_CLASS_NONE,
        "message": "OEMDiagnosticCodeVentilationHeatRecovery",
        "keep_updated": True, 
        "message_data": "u16",
    }),
    "co2_exhaust": SensorSchema({
        "description": "CO2 level exhaust air (0-2000 ppm)",
        "unit_of_measurement": UNIT_EMPTY,"accuracy_decimals": 0, 
        "state_class": STATE_CLASS_NONE,"message": "CO2exhaust",
        "keep_updated": True, 
        "message_data": "u16",
    }),
    "rpm_exhaust": SensorSchema({
        "description": "Exhaust fan speed in rpm",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0, 
        "state_class": STATE_CLASS_NONE,
        "message": "RPMexhaust",
    ...
    "cooling_operation_hours": SensorSchema({
        "description": "Number of hours that the slave is in Cooling Mode. Reset by zero is optional for slave",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "CoolingOperationHours",
        "keep_updated": True,
        "message_data": "u16",
    }),
    "power_cycles": SensorSchema({
        "description": "Number of Power Cycles of a slave (wake-up after Reset)",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "PowerCycles",
    ...
    "electricity_producer_starts": SensorSchema({
        "description": "Number of start of the electricity producer.",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "ElectricityProducerStarts",
        "keep_updated": True,
        "message_data": "u16",
    }),
    "electricity_producer_hours": SensorSchema({
        "description": "Number of hours the electricity produces is in operation",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "ElectricityProducerHours",
        "keep_updated": True,
        "message_data": "u16",
    }),
    "electricity_production": SensorSchema({
        "description": "Current electricity production in Watt.",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "ElectricityProduction",
        "keep_updated": True,
        "message_data": "u16",
    }),
    "cumulative_electricity_production": SensorSchema({
        "description": "Cumulative electricity production in KWh.",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "CumulativElectricityProduction",
        "keep_updated": True,
        "message_data": "u16",
    }),
    "flame_signal_too_low_number": SensorSchema({
        "description": "Number of times flame signal was too low",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "FlameSignalTooLowNumber",
        "keep_updated": True,
        "message_data": "u16",
    }),
})
