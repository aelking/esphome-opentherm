...
SENSORS: Schema[SensorSchema] = Schema({
    ...
    "t_boiler_heat_exchanger": SensorSchema({
    ...
    "flame_current": SensorSchema({
        "description": "Electrical current through burner flame [μA]",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
    ...
    "tr_ch2": SensorSchema({
        "description": "Room temperature for 2nd CH circuit",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "TrCH2",
    ...
    "relative_humidity": SensorSchema({
        "description": "Actual relative humidity as a percentage",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
    ...
    "tr_override2": SensorSchema({
        "description": "Remote Override Room Setpoint 2",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "TrOverride2",
    ...
    "open_therm_version_ventilation_heat_recovery": SensorSchema({
        "description": "The implemented version of the OpenTherm Protocol Specification in the ventilation / heat-recovery system.",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "OpenThermVersionVentilationHeatRecovery",
        "keep_updated": True,
        "message_data": "f88",
    }),
    "tsi": SensorSchema({
        "description": "Supply inlet temperature (°C)",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "Tsi",
    ...
    "tso": SensorSchema({
        "description": "Supply outlet temperature (°C)",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
        "message": "Tso",
    ...
    "open_therm_version_master": SensorSchema({
        "description": "The implemented version of the OpenTherm Protocol Specification in the master.",
        "unit_of_measurement": UNIT_EMPTY,
        "accuracy_decimals": 0,
        "state_class": STATE_CLASS_NONE,
